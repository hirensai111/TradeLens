...
from news_system.collectors import get_collector_registry, run_all_collections
...
from news_system.monitoring.alert_system import NewsIntelligenceAlertSystem
...
class NewsIntelligenceScheduler:
    ...
    def start(self):
        ...
        logger.info("[ROCKET] Starting News Intelligence Scheduler...")
    ...
    def stop(self):
        ...
        logger.info("[OK] Scheduler stopped successfully")
    ...
    def _scheduled_collection(self):
        ...
        try:
            ...
            logger.info(f"[OK] Collection completed: {total_collected} articles in {collection_time:.2f}s")
    ...
    def _scheduled_processing(self):
        ...
        try:
            ...
            logger.info(f"[OK] Processing completed: {processed_count}/{len(articles)} articles in {processing_time:.2f}s")
    ...
    def _scheduled_alert_check(self):
        ...
        try:
            ...
            if all_alerts:
                logger.info(f"[BELL] Generated {len(all_alerts)} alerts")
                ...
                logger.info(f"[CHART] Alert priorities: {priority_counts}")
            ...
            logger.info(f"[OK] Alert check completed in {check_time:.2f}s")
    ...
    def _scheduled_cleanup(self):
        ...
        try:
            ...
            logger.info(f"[OK] Cleanup completed in {cleanup_time:.2f}s:")
...
def start_monitoring_service(email_config=None):
    ...
    print("[ROCKET] Starting News Intelligence Monitoring Service...")
    ...
    try:
        ...
        print("[CHART] Monitoring dashboard:")
        ...
        while scheduler.running:
            ...
            if status['total_collections'] > 0:
                print(f"[UP] Status: {status['total_collections']} collections, "
                ...
                if int(status['uptime_hours']) > 0 and int(status['uptime_hours']) % 1 == 0:
                    ...
                    if 'error' not in overview:
                        print(f"[MONEY] Market Sentiment: {overview.get('overall_sentiment', 0):.3f} "
...
if __name__ == "__main__":
    ...
    try:
        ...
        scheduler.stop()
        print("[OK] Test scheduler stopped")
