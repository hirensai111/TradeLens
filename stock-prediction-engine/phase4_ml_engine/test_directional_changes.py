...
async def test_directional_changes():
    ...
    print("✓ Intraday directional-only strategy selection")
    print("✓ 75% confidence threshold for intraday trades")
    print("✓ NO_TRADE handling with zero legs")
    print("✓ Single-leg structure for directional trades")
    print("✓ Swing trading flexibility preserved")
