    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={clearChat}
            className="text-xs px-3 py-1 rounded-xl transition-colors hover:bg-opacity-80"
            style={{
              color: '#9ca3af',
              border: '1px solid rgba(255, 255, 255, 0.1)',
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.backgroundColor = 'rgba(11, 14, 20, 0.6)';
            }}
            onMouseLeave={(e) => {
        ...
        {ticker && (
          <div
            className="flex gap-4 p-3 rounded-2xl text-xs mt-3"
            style={{
          ...
          >
            <div className={`flex items-start gap-3 max-w-[80%] ${message.isUser ? 'flex-row-reverse' : ''}`}>
              ...
              <div
                ...
                style={{
                  backgroundColor: message.isUser ? '#10b981' : 'rgba(11, 14, 20, 0.8)',
        ...
        <div className="flex flex-wrap gap-2">
          {quickActions.map((action) => (
            <button
              ...
              onMouseLeave={(e) => {
                e.currentTarget.style.backgroundColor = 'rgba(26, 32, 44, 0.6)';
                e.currentTarget.style.color = '#e5e7eb';
              }}
            >
              {action}
