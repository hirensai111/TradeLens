                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-start space-x-2 flex-1 mr-3">
                        <span className="text-lg flex-shrink-0 mt-0.5" style={{ color: getSentimentIndicatorColor(event.sentiment) }}>{getSentimentIndicator(event.sentiment)}</span>
