...
class GraphAnalyzer:
    ...
    def analyze_ticker(self, ticker: str, days: int = 30, include_extended_analysis: bool = True) -> Dict:
        ...
        """
        print(f"[CHART] Analyzing 30-day patterns for {ticker}...")
        ...
        try:
            ...
            print(f"[OK] Pattern analysis complete for {ticker}")
            return analysis
            
        except Exception as e:
            print(f"[ERROR] Graph analysis error for {ticker}: {e}")
            import traceback
            traceback.print_exc()
    ...
    def _get_30day_data(self, ticker: str, days: int) -> Optional[pd.DataFrame]:
        ...
        try:
            ...
            if len(data) < 10:
                print(f"   [WARNING] Insufficient data points: {len(data)}")
                return None
            ...
            print(f"   [UP] Retrieved {len(data)} days of data for {ticker}")
            return data
    ...
    def _preprocess_data(self, data: pd.DataFrame) -> Dict:
        ...
        print(f"   [WRENCH] Preprocessed {processed['length']} days of data with enhanced indicators")
        return processed
...
if __name__ == "__main__":
    print("[ROCKET] Enhanced Graph Analyzer - Advanced Pattern Analysis Engine")
    print("=" * 60)
    ...
    for ticker in test_tickers:
        print(f"\n[CHART] Testing enhanced analysis for {ticker}...")
        print("-" * 40)
        ...
        try:
            ...
            print(f"\n[OK] Analysis Results for {ticker}:")
            ...
            if analysis['momentum_analysis']['momentum_divergence']:
                print(f"[WARNING] Divergence Detected: {analysis['momentum_analysis']['momentum_divergence']}")
            
            # Breakout Analysis
            print(f"\n[ROCKET] Breakout Analysis:")
    ...
    print(f"\n\n[TARGET] Enhanced Graph Analyzer ready for integration!")
    print("[BULB] Key improvements:")
