...
class AlphaVantageSetup:
    ...
    def check_api_key(self) -> bool:
        ...
        if self.api_key:
            print(f"[OK] Found API key in environment: {self.api_key[:8]}...")
            return True
                ...
                with open(self.config_file, 'r') as f:
                    for line in f:
                        if line.startswith('ALPHA_VANTAGE_KEY='):
                            ...
                            if self.api_key:
                                print(f"[OK] Found API key in .env file: {self.api_key[:8]}...")
                                return True
    ...
    def get_api_key_from_user(self) -> str:
        ...
        print("\n[KEY] Alpha Vantage API Key Setup")
        print("-" * 40)
    ...
    def save_api_key(self, api_key: str) -> bool:
        ...
        try:
            ...
            print(f"[ERROR] Error saving API key: {e}")
            return False
    ...
    def test_time_series_data(self, api_key: str) -> Dict[str, Any]:
        ...
        print(f"\n[CHART] Testing time series data...")
    ...
    def run_setup(self) -> bool:
        ...
        print("[ROCKET] Alpha Vantage Integration Setup")
        print("=" * 50)
        ...
        if test_result['success']:
            ...
            if ts_result['success']:
                print("[OK] Time series data test successful!")
                ...
                print(f"[ERROR] Time series test failed: {ts_result['error']}")
                return False
            
        else:
            print(f"[ERROR] API connection test failed: {test_result['error']}")
            print(f"[BULB] Suggestion: {test_result['suggestion']}")
            return False
        ...
        print(f"\n🎉 Setup Complete!")
        print("=" * 50)
        print("[OK] API key configured and tested")
        print("[OK] Connection to Alpha Vantage successful")
        print("[OK] Time series data retrieval working")
        ...
        print(f"\n[ROCKET] Ready to use Enhanced Correlation Analyzer!")
