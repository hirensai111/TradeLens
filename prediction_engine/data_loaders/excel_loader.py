...
class ExcelDataLoader:
    ...
    def debug_performance_data(self):
        ...
        if self.performance_data is not None and not self.performance_data.empty:
            ...
            print("\n[WARNING] No performance data loaded!")
        ...
        if perf_features:
            ...
            print("   [WARNING] No performance features found!")
        ...
        for key in test_keys:
            if key in features:
                found_keys.append(f"[OK] {key}: {features[key]}%")
            else:
        ...
        if any('[OK]' in result for result in found_keys):
